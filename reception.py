...
class reception(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "reception")
        ...
        self._center_freq_win = RangeWidget(self._center_freq_range, self.set_center_freq, 'Tuning', "counter_slider", float)
        self.top_grid_layout.addWidget(self._center_freq_win)
        self._Rx_gain_range = Range(0, 76, 1, 9, 200)
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(-144950000, self.usrp_rate)
...
def main(top_block_cls=reception, options=None):
